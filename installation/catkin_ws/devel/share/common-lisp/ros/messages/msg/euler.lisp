...
(cl:defmethod cl:initialize-instance :after ((m <euler>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'euler)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name messages-msg:<euler> is deprecated: use messages-msg:euler instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <euler>))
